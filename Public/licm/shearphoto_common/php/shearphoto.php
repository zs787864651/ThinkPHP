...
/*..........................................................结果输出给JS..............................................................*/
    ...
    */
    ...
    $uid = $_SESSION['mid'];
   $mysqlInfo = require dirname(dirname(dirname(dirname(__FILE__))))."/Application/Common/Conf/config.php";
   mysql_connect($mysqlInfo['DB_HOST'],$mysqlInfo['DB_USER'],$mysqlInfo['DB_PWD']);
   mysql_select_db($mysqlInfo['DB_NAME']);
   $sql = "UPDATE {$mysqlInfo['DB_PREFIX']}userinfo SET pic  = 'UserPic/{$result[0]['ImgName']}' WHERE uid = {$uid}";
   mysql_query($sql);
